...
const printUsage = () => {
    console.info("usage:");
    console.info("lichess-tournament-creator arena <name> <date> <t_duration> <m_duration> <m_increment>");
    ...
    console.info("");
    console.info("lichess-tournament-creator swiss <name> <team_id> <date> <num_rounds> <m_duration> <m_increment>");
    console.info("\tname:        tournament name");
